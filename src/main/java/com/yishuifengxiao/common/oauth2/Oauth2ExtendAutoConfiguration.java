...
public class Oauth2ExtendAutoConfiguration {
    ...
    public WebResponseExceptionTranslator auth2ResponseExceptionTranslator(@Autowired(required = false) ErrorHelper errorHelper) {
        return new Auth2ResponseExceptionTranslator(errorHelper);
    }
