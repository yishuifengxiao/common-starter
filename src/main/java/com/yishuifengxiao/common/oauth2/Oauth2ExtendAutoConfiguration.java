...
public class Oauth2ExtendAutoConfiguration {
    ...
    /**
     * <p style="color:yellow">RegisteredClientRepository是必需的组件。</p>
    ...
    public Customizer<OAuth2ClientAuthenticationConfigurer> oAuth2ClientAuthenticationConfigurer
            (AuthenticationSuccessHandler authenticationSuccessHandler, AuthenticationFailureHandler errorResponseHandler) {
