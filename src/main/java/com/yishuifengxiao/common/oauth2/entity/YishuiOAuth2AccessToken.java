package com.yishuifengxiao.common.oauth2.entity;
 ...
 * @version 0.0.1
 */
public class YishuiOAuth2AccessToken implements Serializable, OAuth2AccessToken {
	 ...
	 */
	private Integer expireInSeconds = OAuth2Constant.TOKEN_VALID_TIME_IN_SECOND;
	 ...
	 */
	public YishuiOAuth2AccessToken(String value) {
		this.value = value;
	}
	...
	private YishuiOAuth2AccessToken() {
		this((String) null);
	}
	 ...
	 * @param accessToken
	 */
	public YishuiOAuth2AccessToken(OAuth2AccessToken accessToken) {
