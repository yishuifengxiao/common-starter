 ...
 * @since 1.0.0
 */
public class YishuiAccessToken implements Serializable, OAuth2AccessToken {
	 ...
	 */
	public YishuiAccessToken(OAuth2AccessToken accessToken) {
