 ...
 * @since 1.0.0
 */
public class SimpleClientAuthentication implements Customizer<OAuth2ClientAuthenticationConfigurer>{
    ...
    public SimpleClientAuthentication(AuthenticationSuccessHandler authenticationSuccessHandler, AuthenticationFailureHandler errorResponseHandler) {
