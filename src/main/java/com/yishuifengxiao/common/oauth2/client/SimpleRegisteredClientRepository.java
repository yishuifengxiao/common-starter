 ...
 * <p style="color:yellow">RegisteredClientRepository是必需的组件。
 ...
 * </pre>
 *
 * <p>更多内容请参见 <a href="https://docs.spring.io/spring-authorization-server/docs/current/reference/html/core-model-components.html#registered-client">
 * https://docs.spring.io/spring-authorization-server/docs/current/reference/html/core-model-components.html#registered-client</a></p>
 *
 * @author yishui
 * @version 1.0.0
 * @since 1.0.0
