...
public enum MysqlType implements SQLType {
     ...
     * after the decimal point (the scale). The decimal point and (for negative numbers) the "-"
     * sign are not counted in M.
     * If D is 0, values have no decimal point or fractional part. The maximum number of digits
     * (M) for DECIMAL is 65.
     * The maximum number of supported decimals (D) is 30. If D is omitted, the default is 0. If
     ...
     */
    DECIMAL("DECIMAL", Types.DECIMAL, BigDecimal.class, MysqlType.FIELD_FLAG_ZEROFILL,
            MysqlType.IS_DECIMAL, 65L, "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
    /**
     * DECIMAL[(M[,D])] UNSIGNED [ZEROFILL]
     *
    ...
    DECIMAL_UNSIGNED("DECIMAL UNSIGNED", Types.DECIMAL, BigDecimal.class,
            MysqlType.FIELD_FLAG_UNSIGNED | MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL,
     ...
     */
    TINYINT("TINYINT", Types.TINYINT, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL,
            MysqlType.IS_DECIMAL, 3L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * TINYINT[(M)] UNSIGNED [ZEROFILL]
     *
    ...
    TINYINT_UNSIGNED("TINYINT UNSIGNED", Types.TINYINT, Integer.class,
            MysqlType.FIELD_FLAG_UNSIGNED | MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL, 3L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BOOL, BOOLEAN
     ...
     * <p>
     * BOOLEAN is converted to TINYINT(1) during DDL execution i.e. it has the same precision=3.
     * Thus we have to
     * look at full data type name and convert TINYINT to BOOLEAN (or BIT) if it has "(1)" length
     * specification.
     * <p>
     * Protocol: FIELD_TYPE_TINY = 1
     */
     ...
     */
    SMALLINT("SMALLINT", Types.SMALLINT, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL,
            MysqlType.IS_DECIMAL, 5L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * SMALLINT[(M)] UNSIGNED [ZEROFILL]
     *
     ...
     * A normal-size integer. The signed range is -2147483648 to 2147483647. The unsigned range
     * is 0 to 4294967295.
     * <p>
     ...
     */
    INT("INT", Types.INTEGER, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL,
            10L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * INT[(M)] UNSIGNED [ZEROFILL]
     *
     * @see MysqlType#INT
     ...
     * to -1.175494351E-38, 0,
     * and 1.175494351E-38 to 3.402823466E+38. These are the theoretical limits, based on the
     * IEEE standard. The actual
     ...
     * values are stored to the limits permitted by the hardware. A single-precision
     * floating-point number is accurate to
     ...
     * A floating-point number. p represents the precision in bits, but MySQL uses this value
     * only to determine whether
     * to use FLOAT or DOUBLE for the resulting data type. If p is from 0 to 24, the data type
     * becomes FLOAT with no M or D values.
     * If p is from 25 to 53, the data type becomes DOUBLE with no M or D values. The range of
     * the resulting column is the same as
     * for the single-precision FLOAT or double-precision DOUBLE data types.
     */
    FLOAT("FLOAT", Types.REAL, Float.class, MysqlType.FIELD_FLAG_ZEROFILL, MysqlType.IS_DECIMAL,
            12L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FLOAT[(M,D)] UNSIGNED [ZEROFILL]
     *
     * @see MysqlType#FLOAT
     ...
     * A normal-size (double-precision) floating-point number. Permissible values are -1
     * .7976931348623157E+308 to
     * -2.2250738585072014E-308, 0, and 2.2250738585072014E-308 to 1.7976931348623157E+308. These
     * are the theoretical limits,
     * based on the IEEE standard. The actual range might be slightly smaller depending on your
     * hardware or operating system.
     * <p>
     * M is the total number of digits and D is the number of digits following the decimal point.
     * If M and D are omitted,
     * values are stored to the limits permitted by the hardware. A double-precision
     * floating-point number is accurate to
     ...
     * REAL[(M,D)] [UNSIGNED] [ZEROFILL]. Exception: If the REAL_AS_FLOAT SQL mode is enabled,
     * REAL is a synonym for FLOAT rather than DOUBLE.
     */
    DOUBLE("DOUBLE", Types.DOUBLE, Double.class, MysqlType.FIELD_FLAG_ZEROFILL,
            MysqlType.IS_DECIMAL, 22L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DOUBLE[(M,D)] UNSIGNED [ZEROFILL]
     *
    ...
    /**
     * TIMESTAMP[(fsp)]
     * A timestamp. The range is '1970-01-01 00:00:01.000000' UTC to '2038-01-19 03:14:07.999999'
     * UTC.
     * TIMESTAMP values are stored as the number of seconds since the epoch ('1970-01-01
     * 00:00:00' UTC).
     * A TIMESTAMP cannot represent the value '1970-01-01 00:00:00' because that is equivalent to
     * 0 seconds
     * from the epoch and the value 0 is reserved for representing '0000-00-00 00:00:00', the
     * "zero" TIMESTAMP value.
     * An optional fsp value in the range from 0 to 6 may be given to specify fractional seconds
     * precision. A value
     * of 0 signifies that there is no fractional part. If omitted, the default precision is 0.
     * <p>
     * Protocol: FIELD_TYPE_TIMESTAMP = 7
     */
    // TODO If MySQL server run with the MAXDB SQL mode enabled, TIMESTAMP is identical with
    //  DATETIME. If this mode is enabled at the time that a table is created, TIMESTAMP columns
    //  are created as DATETIME columns.
    // As a result, such columns use DATETIME display format, have the same range of values, and
    // there is no automatic initialization or updating to the current date and time
    TIMESTAMP("TIMESTAMP", Types.TIMESTAMP, Timestamp.class, 0, MysqlType.IS_NOT_DECIMAL, 26L, "["
            + "(fsp)]"),
    /**
     ...
     */
    BIGINT("BIGINT", Types.BIGINT, Long.class, MysqlType.FIELD_FLAG_ZEROFILL,
            MysqlType.IS_DECIMAL, 19L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BIGINT[(M)] UNSIGNED [ZEROFILL]
     *
     ...
     */
    MEDIUMINT("MEDIUMINT", Types.INTEGER, Integer.class, MysqlType.FIELD_FLAG_ZEROFILL,
            MysqlType.IS_DECIMAL, 7L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * MEDIUMINT[(M)] UNSIGNED [ZEROFILL]
     *
     ...
     * 'HH:MM:SS[.fraction]' format, but permits assignment of values to TIME columns using
     ...
     */
    DATETIME("DATETIME", Types.TIMESTAMP, LocalDateTime.class, 0, MysqlType.IS_NOT_DECIMAL, 26L,
            "[(fsp)]"),
    /**
     * YEAR[(4)]
     * A year in four-digit format. MySQL displays YEAR values in YYYY format, but permits
     * assignment of
     * values to YEAR columns using either strings or numbers. Values display as 1901 to 2155,
     * and 0000.
     ...
     * bytes, which is shared among
     * all columns) and the character set used. For example, utf8 characters can require up to
     * three bytes per character,
     * so a VARCHAR column that uses the utf8 character set can be declared to be a maximum of
     * 21,844 characters.
     * <p>
     * MySQL stores VARCHAR values as a 1-byte or 2-byte length prefix plus data. The length
     * prefix indicates the number
     * of bytes in the value. A VARCHAR column uses one length byte if values require no more
     * than 255 bytes, two length
     * bytes if values may require more than 255 bytes.
     * <p>
     * Note
     * MySQL 5.7 follows the standard SQL specification, and does not remove trailing spaces from
     * VARCHAR values.
     * <p>
     * VARCHAR is shorthand for CHARACTER VARYING. NATIONAL VARCHAR is the standard SQL way to
     * define that a VARCHAR
     * column should use some predefined character set. MySQL 4.1 and up uses utf8 as this
     ...
     */
    VARCHAR("VARCHAR", Types.VARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 65535L, "(M) "
    ...
    /**
     * BIT[(M)]
     * A bit-field type. M indicates the number of bits per value, from 1 to 64. The default is 1
     * if M is omitted.
     * Protocol: FIELD_TYPE_BIT = 16
     */
    BIT("BIT", Types.BIT, Boolean.class, 0, MysqlType.IS_DECIMAL, 1L, "[(M)]"), // TODO maybe
    // precision=8 ?
    /**
     * The size of JSON documents stored in JSON columns is limited to the value of the
     * max_allowed_packet system variable (max value 1073741824).
     * (While the server manipulates a JSON value internally in memory, it can be larger; the
     * limit applies when the server stores it.)
     * <p>
     ...
     * values 'value1',
     * 'value2', ..., NULL or the special '' error value. ENUM values are represented internally
     * as integers.
     * An ENUM column can have a maximum of 65,535 distinct elements. (The practical limit is
     * less than 3000.)
     * A table can have no more than 255 unique element list definitions among its ENUM and SET
     ...
     * A set. A string object that can have zero or more values, each of which must be chosen
     * from the list
     * of values 'value1', 'value2', ... SET values are represented internally as integers.
     * A SET column can have a maximum of 64 distinct members. A table can have no more than 255
     * unique
     * element list definitions among its ENUM and SET columns considered as a group
     * <p>
     * Protocol: FIELD_TYPE_SET = 248
     */
    SET("SET", Types.CHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 64L, "('value1','value2',.."
            + ".) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * TINYBLOB
     ...
     * Protocol:FIELD_TYPE_TINY_BLOB = 249
     */
    TINYTEXT("TINYTEXT", Types.VARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 255L, " "
            + "[CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * MEDIUMBLOB
     * A BLOB column with a maximum length of 16,777,215 (224 - 1) bytes. Each MEDIUMBLOB value
     * is stored
     ...
     * maximum length
     * is less if the value contains multibyte characters. Each MEDIUMTEXT value is stored using
     * a 3-byte
     * length prefix that indicates the number of bytes in the value.
     * <p>
     * Protocol: FIELD_TYPE_MEDIUM_BLOB = 250
     */
    MEDIUMTEXT("MEDIUMTEXT", Types.LONGVARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL,
            16777215L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * LONGBLOB
     * A BLOB column with a maximum length of 4,294,967,295 or 4GB (232 - 1) bytes. The effective
     * maximum length
     * of LONGBLOB columns depends on the configured maximum packet size in the client/server
     * protocol and available
     * memory. Each LONGBLOB value is stored using a 4-byte length prefix that indicates the
     ...
     * effective
     * maximum length is less if the value contains multibyte characters. The effective maximum
     * length
     * of LONGTEXT columns also depends on the configured maximum packet size in the
     * client/server protocol
     * and available memory. Each LONGTEXT value is stored using a 4-byte length prefix that
     * indicates
     * the number of bytes in the value.
     * <p>
     * Protocol: FIELD_TYPE_LONG_BLOB = 251
     */
    LONGTEXT("LONGTEXT", Types.LONGVARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL,
            4294967295L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BLOB[(M)]
     ...
     * length
     * is less if the value contains multibyte characters. Each TEXT value is stored using a
     * 2-byte length
     ...
     * Protocol: FIELD_TYPE_BLOB = 252
     */
    TEXT("TEXT", Types.LONGVARCHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 65535L, "[(M)] "
            + "[CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * [NATIONAL] CHAR[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]
     * A fixed-length string that is always right-padded with spaces to the specified length when
     * stored.
     * M represents the column length in characters. The range of M is 0 to 255. If M is omitted,
     * the length is 1.
     * Note
     * Trailing spaces are removed when CHAR values are retrieved unless the
     * PAD_CHAR_TO_FULL_LENGTH SQL mode is enabled.
     * CHAR is shorthand for CHARACTER. NATIONAL CHAR (or its equivalent short form, NCHAR) is
     * the standard SQL way
     * to define that a CHAR column should use some predefined character set. MySQL 4.1 and up
     * uses utf8
     * as this predefined character set.
     * <p>
     * MySQL permits you to create a column of type CHAR(0). This is useful primarily when you
     * have to be compliant
     * with old applications that depend on the existence of a column but that do not actually
     * use its value.
     * CHAR(0) is also quite nice when you need a column that can take only two values: A column
     * that is defined
     * as CHAR(0) NULL occupies only one bit and can take only the values NULL and '' (the empty
     * string).
     * <p>
     * Protocol: FIELD_TYPE_STRING = 254
     */
    CHAR("CHAR", Types.CHAR, String.class, 0, MysqlType.IS_NOT_DECIMAL, 255L, "[(M)] [CHARACTER "
     ...
     */
    GEOMETRY("GEOMETRY", Types.BINARY, null, 0, MysqlType.IS_NOT_DECIMAL, 65535L, ""), // TODO
    // check precision, it isn't well documented, only mentioned that WKB format is represented
    // by BLOB
    /**
    ...
    /**
     * Get MysqlType matching the full MySQL type name, for example "DECIMAL(5,3) UNSIGNED
     * ZEROFILL".
    ...
    public static MysqlType getByName(String fullMysqlTypeName) {
        ...
        // TODO parse complex names like [NATIONAL] VARCHAR(M) [CHARACTER SET charset_name]
        ...
        if (StringUtils.indexOfIgnoreCase(typeName, "DECIMAL") != -1 || StringUtils.indexOfIgnoreCase(typeName, "DEC") != -1
            ...
            return StringUtils.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullMysqlTypeName, "ZEROFILL") != -1
                ...
                /* || StringUtils.indexOfIgnoreCase(name, "DOUBLE PRECISION") != -1 is caught by
                "DOUBLE" check */
                // IMPORTANT: "FLOAT8" must be checked before "FLOAT"
                || StringUtils.indexOfIgnoreCase(typeName, "FLOAT8") != -1) {
            // TODO Exception: If the REAL_AS_FLOAT SQL mode is enabled, REAL is a synonym for
         ...
         * "FLOAT" check
         */) {
            // TODO FLOAT(p) [UNSIGNED] [ZEROFILL]. If p is from 0 to 24, the data type becomes
            //  FLOAT with no M or D values. If p is from 25 to 53, the data type becomes DOUBLE
            //  with no M or D values.
            return StringUtils.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 || StringUtils.indexOfIgnoreCase(fullMysqlTypeName, "ZEROFILL") != -1
                    ? FLOAT_UNSIGNED
                    : FLOAT;
        ...
        } else if (StringUtils.indexOfIgnoreCase(typeName, "GEOM") != -1 // covers "GEOMETRY",
                // "GEOMETRYCOLLECTION" and "GEOMCOLLECTION"
                || StringUtils.indexOfIgnoreCase(typeName, "POINT") != -1 // also covers
                // "MULTIPOINT"
                || StringUtils.indexOfIgnoreCase(typeName, "POLYGON") != -1 // also covers
            // "MULTIPOLYGON"
        ) {
            return GEOMETRY; // TODO think about different MysqlTypes for Spatial Data Types
    ...
    public static MysqlType getByJdbcType(int jdbcType) {
        switch (jdbcType) {
            ...
            case Types.REF_CURSOR:
                throw new UncheckedException("REF_CURSOR type is not supported");
            case Types.TIME_WITH_TIMEZONE:
                throw new UncheckedException("TIME_WITH_TIMEZONE type is not supported");
            case Types.TIMESTAMP_WITH_TIMEZONE:
                throw new UncheckedException("TIMESTAMP_WITH_TIMEZONE type is not "
                        + "supported");
    ...
    public static boolean supportsConvert(int fromType, int toType) {
        ...
        switch (fromType) {
            ...
            /*
             * The numeric types. Basically they can convert among themselves, and with
             * char/binary types.
             */
            case java.sql.Types.DECIMAL:
            case java.sql.Types.NUMERIC:
            ...
            /*
             * With this driver, this will always be a serialized object, so the char/binary
             * types will work.
             */
            case java.sql.Types.OTHER:
            ...
            case java.sql.Types.TIME:
                ...
                /*
                 * Timestamp can be converted to char/binary types and date/time types (with loss
                 *  of precision).
                 */
            case java.sql.Types.TIMESTAMP:
     ...
     * @param isDec         isDec
     * @param precision     represents the maximum column size that the server supports for the
     *                      given datatype.
     *                      <ul>
     *                      <li>For numeric data, this is the maximum precision.
     *                      <li>
     *                      For character data, this is the length in characters.
     *                      <li>For datetime datatypes, this is the length in characters of the
     *                      String
     ...
     *                      <li>Null is returned for data types where the column size is not
     *                      applicable.
     *                      </ul>
     * @param createParams  params
     */
    private MysqlType(String mysqlTypeName, int jdbcType, Class<?> javaClass, int allowedFlags,
                      boolean isDec, Long precision, String createParams) {
