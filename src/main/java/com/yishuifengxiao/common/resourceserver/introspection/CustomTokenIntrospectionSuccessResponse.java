...
public class CustomTokenIntrospectionSuccessResponse extends TokenIntrospectionResponse implements SuccessResponse {
	...
	public static class Builder {
		...
		/**
		 * Sets the client X.509 certificate SHA-256 thumbprint, for a mutual TLS client
		 * certificate bound access token. Corresponds to the {@code cnf.x5t#S256}
		 * claim.
		 *
		 * @param x5t The client X.509 certificate SHA-256 thumbprint, {@code null} if
		 *            not specified.
		 *
		 * @return This builder.
		 */
		 ...
		 * claim.
		 *
		 * @param cnf The client X.509 certificate confirmation, {@code null} if not
		 *            specified.
		 *
		 * @return This builder.
		 */
	...
	/**
	 * Returns the client X.509 certificate SHA-256 thumbprint, for a mutual TLS
	 * client certificate bound access token. Corresponds to the
	 * {@code cnf.x5t#S256} claim.
	 *
	 *
	 * @return The client X.509 certificate SHA-256 thumbprint, {@code null} if not
	 *         specified.
	 */
	@Deprecated
	 ...
	 * claim.
	 *
	 * @return The client X.509 certificate confirmation, {@code null} if not
	 *         specified.
	 */
