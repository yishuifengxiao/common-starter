...
public class CurrentUserDetails implements UserDetails, CredentialsContainer {
    ...
    private static final Log logger = LogFactory.getLog(CurrentUserDetails.class);
    ...
    /**
     * Construct the <code>CurrentUserDetails</code> with the details required by
     ...
     */
    public CurrentUserDetails(String username, String password, boolean enabled, boolean accountNonExpired,
    ...
    public CurrentUserDetails setCurrentUser(Object currentUser) {
    ...
    /**
     * Returns {@code true} if the supplied object is a {@code CurrentUserDetails} instance with the
    ...
    public boolean equals(Object obj) {
        if (obj instanceof CurrentUserDetails currentUserDetails) {
            return this.username.equals(currentUserDetails.getUsername());
        }
        return false;
    }
     ...
     * <pre>
     * <code>
     * UserDetails user = CurrentUserDetails.withDefaultPasswordEncoder()
     *     .username("user")
     *     .password("password")
     *     .roles("USER")
     *     .build();
     ...
     * <pre>
     * <code>
     * UserDetails user = CurrentUserDetails.withUsername("user")
    ...
    public static UserBuilder withDefaultPasswordEncoder() {
        logger.warn("CurrentUserDetails.withDefaultPasswordEncoder() is considered unsafe for production "
    ...
    public static final class UserBuilder {
        ...
        public UserDetails build() {
            ...
            return new CurrentUserDetails(this.username, encodedPassword, !this.disabled, !this.accountExpired,
