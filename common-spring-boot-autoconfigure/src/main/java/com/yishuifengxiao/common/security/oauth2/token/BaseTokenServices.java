...
public abstract class BaseTokenServices
	 ...
	 *                               the original scope.
	 */
	protected abstract OAuth2Authentication createRefreshedAuthentication(OAuth2Authentication authentication,
	 ...
	 * @return
	 */
	protected abstract OAuth2AccessToken createAccessToken(OAuth2Authentication authentication,
	 ...
	 * @return
	 */
	protected abstract OAuth2RefreshToken createRefreshToken(OAuth2Authentication authentication);
	...
	public BaseTokenServices(TokenStore tokenStore, ClientDetailsService clientDetailsService,
